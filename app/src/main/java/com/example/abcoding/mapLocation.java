...
import com.example.abcoding.databinding.ActivityMapLocationBinding;
...
public class mapLocation extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        double Logtitudes = intent.getDoubleExtra("Logtitude",0.0);

        // Add a marker in Sydney and move the camera
        LatLng latLng = new LatLng(Latitudes, Logtitudes);
        mMap.addMarker(new MarkerOptions().position(latLng).title("surat branch"));
